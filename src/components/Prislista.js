    ...
    <div className="prislista">
      ...
      <div className="pricing">
        ...
        <div className="price-item">
          ...
          <p>30 minuter, 400 kr</p>
        </div>
        <div className="price-item">
          <h3>Laser – halva ben</h3>
          <p>30 minuter, 800 kr</p>
        </div>
        <div className="price-item">
          <h3>Laser – rumpa (kvinna)</h3>
          <p>30 minuter, 500 kr</p>
        </div>
        <div className="price-item">
          <h3>Laser – rygg (kvinna)</h3>
          <p>30 minuter, 1 000 kr</p>
        </div>
        <div className="price-item">
          <h3>Laser – hela armar</h3>
          <p>50 minuter, 800 kr</p>
        </div>
        <div className="price-item">
          <h3>Laser – hela ben</h3>
          <p>60 minuter, 1 600 kr</p>
        </div>
        <div className="price-item">
          <h3>Vaxning – hela rumpa</h3>
          <p>20 minuter, 299 kr</p>
        </div>

        <h2 className="category-title">Vaxning</h2>
        <div className="price-item">
          <h3>Brasiliansk vaxning (rumpa ingår)</h3>
          <p>60 minuter, 499 kr</p>
        </div>
        <div className="price-item">
          <h3>Brasiliansk vaxning + armhålor</h3>
          <p>60 minuter, 599 kr</p>
        </div>
        <div className="price-item">
          <h3>Brasiliansk vaxning + armhålor + baksida lår</h3>
          <p>60 minuter, 750 kr</p>
        </div>
        <div className="price-item">
        ...
        <div className="price-item">
          ...
          <p>20 minuter, 199 kr</p>
        </div>
        <div className="price-item">
          <h3>Vaxning – halva ben</h3>
          <p>40 minuter, 350 kr</p>
        </div>
        <div className="price-item">
        ...
        <div className="price-item">
          ...
          <p>30 minuter, 300 kr</p>
        </div>
        <div className="price-item">
          <h3>Vaxning – hela ben</h3>
          <p>60 minuter, 650 kr</p>
        </div>
        <div className="price-item">
